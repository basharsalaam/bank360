...
export const DashboardLayoutStyle = styled.section<{
  ...
  .side-bar {
    width: ${(props) => (props.collapsedMenu ? "94px" : "250px")};
    min-height: 100vh;
  ...
  .main {
    margin-left: ${(props) => (props.collapsedMenu ? "120px" : "250px")};
    width: ${(props) => props.collapsedMenu ? "calc(100% - 94px)" : "calc(100% - 250px)"};
